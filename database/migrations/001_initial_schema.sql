...
-- Description: Creates all initial tables, indexes, and triggers for the CRM system
...
-- Create triggers for updated_at (drop first if exists to avoid conflicts)
...
VALUES (
  ...
  'Admin User', 
  'admin@example.com',
  '$2b$10$rKvVLYqQYJ7YZXvXqYzQJ.FZ5y5vZ5YqZzQJ7YZXvXqYzQJ7YZXvX',
  'Admin'
)
